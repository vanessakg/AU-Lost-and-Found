describe("Check the checkValid Function", function(){
    ...
    context("Check age", function(){
        it("checkValid is true with an age between 16 and 130", function(){
            let vac = new vacationDays(45, 10);
            chai.assert.isTrue(vac.checkValid(16,130, vac.age));
        });
        it("checkValid is true with an age of 16", function(){
            let vac = new vacationDays(16, 10);
            chai.assert.isTrue(vac.checkValid(16,130, vac.age));
        });
        it("checkValid is true with an age of 130", function(){
